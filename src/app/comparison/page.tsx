        ...
        <section className="py-6">
          ...
          >
            {timelineEvents.map((t, i) => {
              const color = t.type === 'tobe' ? '#ff6b35'
                : t.type === 'milestone' ? '#ff6b35'
                : t.type === 'stale' ? '#ff4444'
                : '#6a6a7a';
              ...
              return (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:gap-4">
                    ...
                    {t.type === 'milestone' && (
                      <span className="inline-block rounded border border-[#ff6b35]/40 bg-[#ff6b35]/10 px-2 py-0.5 text-[0.6rem] font-bold tracking-[0.15em] text-[#ff6b35]">
