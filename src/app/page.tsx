...
export default function Home() {
  ...
  if (!booted) {
    return (
      <div className="flex min-h-[80vh] flex-col items-center justify-center bg-[#0a0a0f] font-mono">
        ...
        {showSkip && (
          <button
            ...
            className="mt-12 font-mono text-xs tracking-[0.1em] text-white/45 transition-colors hover:text-white/50"
          >
            SKIP ▸
          </button>
        )}
    ...
    <div className="relative min-h-screen bg-[#0a0a0f] font-mono text-white">
      ...
      <div className="flex justify-end px-6 pt-4">
        <button
          ...
          className="text-[0.6rem] tracking-[0.1em] text-[#3a3a4a] transition-colors hover:text-[#8a8a9a]"
        >
